...
<body>
    ...
    <!-- body -->
    <div class="container">
        <br><h3 align="center">จัดการห้อง</h3>
        <div class="row">
    ...
    <div class="card">
                    ...
                    <div class="col">
                        <div class="card-body">
                        <div class="row">
                            <div class="col-4" style="background:#3498DB;">
                            <br>
                            <a href="room_history"  class="btn btn-primary">
                                <img src="img/icons/call-center.png" style="width:50%;"/>
                                <p>บันทึกการจองห้อง</p>
                            </a>
                            </div>
                            <div class="col-8">
                                <div id='calendar'></div>
        ...
        <center>
            ...
            <table class="table" id="mytable">
                ...
                <tbody>
                    ...
                    <td>
                    <a  href="room_change_status/{{$data_room->room_id}}/1/{{ session('user_id') }}" class="btn btn-primary">อนุมัติ</a>
                    </td>
                    <td>
                    <a href="room_change_status/{{$data_room->room_id}}/2/{{ session('user_id') }}" class="btn btn-danger">ไม่อนุมัติ</a>
                    </td>
                    </tr>
                    <?php $i++; ?>
                    @endforeach
